                        ...
                        <Formik
                            ...
                            <Form>
                                ...
                                <MyFormView>
                                    ...
                                    <MyFormField id="night_rate" name="night_rate" placeholder={oldParking ? oldParking.night_rate : "4.2"} step="0.1" min="0.1" type="number"/>
                                </MyFormView>

                                <MyFormView>
                                    <MyFormText htmlFor="day_time_start">Początek dnia:</MyFormText>
                                    <MyFormField id="day_time_start" name="day_time_start" placeholder={oldParking ? oldParking.day_time_start : "08:30"} type="text"/>
                                </MyFormView>

                                <MyFormView>
                                    <MyFormText htmlFor="day_time_end">Koniec dnia:</MyFormText>
                                    <MyFormField id="day_time_end" name="day_time_end" placeholder={oldParking ? oldParking.day_time_end : "21:45"} type="text"/>
                                </MyFormView>
                                ...
                                <MyFormView>
                                    ...
                                    <MyFormField id="first_hour" name="first_hour" placeholder={(oldParking && oldParking.extra_rules) ? oldParking.extra_rules.first_hour : "3.1"} step="0.1" min="0.1" type="number"/>
                                </MyFormView>

                                <MyFormView>
                                    <MyFormText htmlFor="rate_from_six_hours">Następne 6 godzin:</MyFormText>
                                    <MyFormField id="rate_from_six_hours" name="rate_from_six_hours" placeholder={(oldParking && oldParking.extra_rules) ? oldParking.extra_rules.rate_from_six_hours : "0.2"} step="0.1" min="0.1" type="number"/>
                                </MyFormView>
